...
<?php
	if($uid==-1)
	{
		...
		echo "<h3>REGISTER TODAY TO START SOLVING THE QUIZ AND GET TO THE TOP OF THE LEADERBOARD!!!</h3>";
		echo "<br><p>Please Send us your Valuable Suggestions to help us create a Better Platform</p>";
		echo "</div>";
		?>
		<?php
	}
